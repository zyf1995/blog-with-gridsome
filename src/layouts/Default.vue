<template>
    <div class="layout">
        ...
        <h1 class="project-name">飞大哒的博客</h1>
        <h2 class="project-tagline">生活，学习，感悟</h2>
        <a href="" class="btn" target="_blank">GitHub主页</a>
        <a href="https://github.com/zyf1995/" class="btn" target="_blank">博客源码</a>
        </section>
                ...
                <el-row>
                    ...
                    <el-col :span="4" style="text-align: right;">
                        ...
                        <div style="color:#606266;">
                            <i class="el-icon-location"></i>&nbsp;杭州市
                            <br>
                        </div>
                    </el-col>
                    <el-col :span="2" style="text-align: center;">
                        ...
                        />
                        <el-popover ref="bigAvatar" placement="top-start" title="github-zyf" width="200" trigger="hover">
                            <i class="el-icon-star-on"></i>&emsp;zyf1995
                            <br>
                            <i class="el-icon-location"></i>&emsp;杭州市
                            <br>
...
export default {
    ...
    data() {
        return {
            ...
            avatarUrl: "https://avatars2.githubusercontent.com/u/51917704?s=460&u=21a305bcbce530169f9f65f45348b53e8b089595&v=4",
            audioUrl: '',
            audioAutoPlay: false
        }
    },
